...
ALTER TABLE sdis.dangers ADD COLUMN geom         geometry(Point, 2056);
...
ALTER TABLE sdis.risques ADD COLUMN geom         geometry(Point, 2056);
...
ALTER TABLE sdis.signalisation ADD COLUMN geom        geometry(Point, 2056);
...
ALTER TABLE sdis.emplacements ADD COLUMN geom     geometry(Point, 2056);
...
ALTER TABLE sdis.cles ADD COLUMN geom          geometry(Point, 2056);
...
ALTER TABLE sdis.bornes_hydrantes ADD COLUMN geom     geometry(Point, 2056);
...
ALTER TABLE sdis.puits_reservoirs ADD COLUMN geom     geometry(Point, 2056);
...
ALTER TABLE sdis.tuyaux ADD COLUMN geom     geometry(MultiLineString, 2056);
...
ALTER TABLE sdis.sites ADD COLUMN geom      geometry(Point, 2056);
...
ALTER TABLE sdis.secteurs_intervention ADD COLUMN geom      geometry(MultiPolygon, 2056);
...
ALTER TABLE sdis.secteurs_organisationnels ADD COLUMN geom geometry(MultiPolygon, 2056);
